...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=whistle-blower,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        py_logging.warning(f"GCP Application Default Credentials not found. Skipping Agent Engine telemetry setup. Error: {e}")
